...
\begin{description}
\item[$A_1$] LEO analysis tool and evaluation infrastructure. Zenodo archive: \url{https://doi.org/10.5281/zenodo.19704349} (concept DOI --- always resolves to the latest release; the reviewed snapshot is tag \texttt{v0.1.3-sc26-ae} at \url{https://doi.org/10.5281/zenodo.19706017}). Pre-collected profiling data (separate deposit, $\sim$1~GB): \url{https://doi.org/10.5281/zenodo.19705577}.
\end{description}
