...
class Domain {
  ...
  // private:
   ...
   // Gathered node data for GPU-friendly contiguous access (8 nodes per element)
   Real_t *m_gx ;    // [numElem * 8] - gathered x coordinates
   Real_t *m_gy ;    // [numElem * 8] - gathered y coordinates
   Real_t *m_gz ;    // [numElem * 8] - gathered z coordinates
   Real_t *m_gxd ;   // [numElem * 8] - gathered x velocities
   Real_t *m_gyd ;   // [numElem * 8] - gathered y velocities
   Real_t *m_gzd ;   // [numElem * 8] - gathered z velocities
