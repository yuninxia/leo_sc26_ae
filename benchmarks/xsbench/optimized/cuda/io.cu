...
void binary_write( Inputs in, SimulationData SD )
{
	...
	fwrite(SD.nuclide_grid_energy, sizeof(double), SD.length_nuclide_grid, fp);
...
SimulationData binary_read( Inputs in )
{
	...
	// OPT: Extract energy-only array from the nuclide grid for cache-efficient binary search
