...
SimulationData grid_init_do_not_profile( Inputs in, int mype )
{
	...
	// Binary search reads only the 8-byte energy field but the full
	// NuclideGridPoint struct is 48 bytes — extracting energies into a
	// contiguous double array gives 6x better cache-line utilization.
