...
// BF16 input, FP32 accumulation, BF16 output — 1024x1024 GEMM on MI300A (gfx942)
// Adapted from HipKittens analysis/bf16_gemm/mi325x/kernel_1024.cpp
...
int main() {
    // Allocate device memory for 1024x1024 BF16 matrices
