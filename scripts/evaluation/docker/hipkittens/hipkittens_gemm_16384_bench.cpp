...
// BF16 input, FP32 accumulation, BF16 output — 16384x16384 GEMM on MI300A (gfx942)
// Adapted from HipKittens analysis/bf16_gemm/mi325x/kernel_16384.cpp
...
int main() {
    // Allocate device memory for 16384x16384 BF16 matrices
