...
// BF16 input, FP32 accumulation, BF16 output — 2048x2048 GEMM on MI300A (gfx942)
// Adapted from HipKittens analysis/bf16_gemm/mi325x/kernel_2048.cpp
...
int main() {
    // Allocate device memory for 2048x2048 BF16 matrices
