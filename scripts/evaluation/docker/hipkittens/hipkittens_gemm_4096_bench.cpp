...
// BF16 input, FP32 accumulation, BF16 output — 4096x4096 GEMM on MI300A (gfx942)
// Adapted from HipKittens analysis/bf16_gemm/mi325x/kernel_4096.cpp
...
int main() {
    // Allocate device memory for 4096x4096 BF16 matrices
